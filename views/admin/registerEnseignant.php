...
<body class="bg-admin vh-100 d-flex align-items-center" style="background: url('../../public/img/bg-form.jpg') center/cover no-repeat;">
    <div class="container justify-content-center align-items-center d-flex min-vh-100">
            <div class="login-box ">
                ...
                <form method="POST" action="../../index.php?page=enseignant/register" enctype="multipart/form-data" id="registerForm">
                    ...
                    <div class="input-group form-group">
                        <input type="text" id="grade" name="grade" class="input-field form-control" required>
                        <label for="grade" class="label">Grade</label>
                    </div>
                    <div class="input-group form-group">
                        <input type="text" id="fonction" name="fonction" class="input-field  form-control" required>
                        <label for="fonction" class="label">Fonction</label>
                    </div>
                    <div class="input-group form-group">
                        <input type="text" id="lieuTravail" name="lieuTravail" class="input-field  form-control" required>
